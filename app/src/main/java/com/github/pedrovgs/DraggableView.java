...
public class DraggableView extends RelativeLayout {
   ...
   private boolean touchEnabled = true;//kk; default to true per manual screen flips
   ...
   protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
      ...
      if (isPortrait()) {
         ...
         Log.i("test", "DraggableView.onLayout() landscape " + left + " " + top + " " + right + "" +
               " " + bottom + " " + dragView.getMeasuredWidth() + " " + dragView.getMeasuredHeight());
   ...
   protected void onConfigurationChanged(Configuration newConfig) {
      ...
      Log.i("test", "DraggableView.onConfigurationChanged() " + (isPortrait() ? "portrait" : "landscape"));
   }
